...
MANGANESE.createNS = function (namespace) {
  var nsparts = namespace.split(".");
  var parent = MANGANESE;

  // we want to be able to include or exclude the root namespace 
  // So we strip it if it's in the namespace
  if (nsparts[0] === "MANGANESE") {
...
MANGANESE.createNS("MANGANESE.MODEL.PRODUCTS");
...
// It does 3 things :
//  - retri
MANGANESE.MODEL.PRODUCTS.player = function(){
  // private variables
...
MANGANESE.createNS("MANGANESE.LOGIC.BUSINESS");


MANGANESE.LOGIC.BUSINESS.init = function () {
  var model = MANGANESE.MODEL.PRODUCTS;
  var p = new model.player();

  p.launch();
};

MANGANESE.LOGIC.BUSINESS.init();
